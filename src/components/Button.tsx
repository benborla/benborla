...
const defaultStyle = "bg-lime-400 px-5 py-2 active:bg-neongreen border-b-gray-400 border-r-gray-500 border-b-3 border-r-3 active:border-l-3 active:border-r-0 active:border-r-gray-500 active:border-b-gray-700";
